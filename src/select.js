...
async function scoreBatch(posts) {
  ...
  const { scores } = await jsonCall({
    system: [
      ...
      "후보는 전세계 여러 언어의 수의 전문 미디어·학회·대학·지역 매체 기사와 수의사 커뮤니티 글이 섞여 있습니다.",
      "영어가 아닌 원문도 내용 자체로 평가하고, 국가나 언어가 낯설다는 이유만으로 감점하지 마세요.",
      "각 글이 한국 수의사 독자에게 얼마나 가치 있는지 relevance 0~10점으로 평가하세요.",
      "높은 점수: 개·고양이 임상 지견·케이스 토론, 병원 경영·인력 문제, 번아웃·커리어, 진료비/보호자 커뮤니케이션, 새 치료법·장비, 국제 감염병 조기경보, 여러 국가에 적용 가능한 업계 트렌드.",
      "국가별 제도 기사라도 한국 동물병원이 미리 대비하거나 비교할 가치가 있으면 높게 평가하세요.",
      "낮은 점수: 특정 보호자의 개인 의료상담, 현지 행정 공지만 있고 다른 나라에 적용할 통찰이 없는 글, 제품 홍보·웨비나 안내, 단순 잡담, 특정 인물·병원 비방.",
