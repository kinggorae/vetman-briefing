...
test("quality gate keeps thin or garbled briefs out of the compact feed", () => {
  ...
  const readableBrief = {
    tier: "brief",
    titleKo: "충분한 분량의 핵심 브리핑 제목입니다",
    leadKo: "출처가 확인된 소식의 핵심 사실과 배경을 설명합니다. 동물병원 독자가 왜 알아야 하는지와 원문에서 확인할 지점을 함께 정리한 내용입니다. 연구 또는 현장 사례의 범위와 해석에서 주의할 점도 안내합니다. 국내 진료 환경에 적용할 때 추가로 확인해야 할 조건을 덧붙입니다. 단순한 제목 반복이 아니라 독자가 다음 판단을 할 수 있도록 맥락과 한계를 함께 전달합니다. 지금 바로 적용해야 할 지침이 아니라 후속 확인이 필요한 참고 정보라는 점도 명시합니다. 실제 운영에 참고할 때는 원문과 최신 근거를 직접 대조해야 합니다. 적용 전에는 담당자의 판단과 최신 자료를 기준으로 범위를 확인합니다. 현장 적용 여부는 개별 상황에 따라 달라집니다.",
    bodyKo: ["출처가 확인된 소식의 핵심 사실과 배경을 설명합니다. 동물병원 독자가 왜 알아야 하는지와 원문에서 확인할 지점을 함께 정리한 내용입니다. 연구 또는 현장 사례의 범위와 해석에서 주의할 점도 안내합니다. 국내 진료 환경에 적용할 때 추가로 확인해야 할 조건을 덧붙입니다. 단순한 제목 반복이 아니라 독자가 다음 판단을 할 수 있도록 맥락과 한계를 함께 전달합니다. 지금 바로 적용해야 할 지침이 아니라 후속 확인이 필요한 참고 정보라는 점도 명시합니다. 실제 운영에 참고할 때는 원문과 최신 근거를 직접 대조해야 합니다. 적용 전에는 담당자의 판단과 최신 자료를 기준으로 범위를 확인합니다. 현장 적용 여부는 개별 상황에 따라 달라집니다."],
  };
  assert.ok(!qualityIssues(readableBrief).includes("brief-too-short"));
